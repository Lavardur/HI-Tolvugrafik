...
//var vertices = new Float32Array([-0.05, 0.65, 0.05, 0.65, 0.05, 0.75, -0.05, 0.75]);
...
function getRandomHeight(min, max) {
  ...
  var cubes = [];
  for (var i = 0; i < 5; i++) {
    var yOffset = getRandomHeight(0.5, 0.9);
  
    // Define vertices for each cube with the same x and z values but different y values
    var vertices = new Float32Array([
      -0.05, yOffset - 0.05,  // Bottom-left
      0.05, yOffset - 0.05,   // Bottom-right
      0.05, yOffset + 0.05,   // Top-right
      -0.05, yOffset + 0.05   // Top-left
    ]);
