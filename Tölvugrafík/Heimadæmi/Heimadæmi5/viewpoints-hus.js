...
window.onload = function init()
{
    ...
    window.addEventListener("keydown", function(e){
        switch( e.keyCode ) {
            ...
            case 57:	// 9: ofan á húsinu sem er í hnitum (-40, 140) og horfir alltaf á bílinn.
                view = 9;
                document.getElementById("Viewpoint").innerHTML = "9: ofan á húsinu sem er í hnitum (-40, 140) og horfir alltaf á bílinn";
                break;    
...
function render()
{
	...
	case 8:
	    ...
	    break;
    case 9:
	    // ofan á húsinu sem er í hnitum (-40, 140) og horfir alltaf á bílinn.
